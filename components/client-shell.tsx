...
type Action = () => void;
const nav = [["/", "Início", "Home"], ["/experiencia", "Experiência", "Experience"], ["/projetos", "Projetos", "Projects"], ["/sobre", "Sobre", "About"], ["/curriculo", "Currículo", "Resume"], ["/contato", "Contato", "Contact"]] as const;
