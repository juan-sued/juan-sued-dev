...
type Props = { children: React.ReactNode; locale: Locale; theme: "light" | "dark"; recruiter: boolean; resumeUrls: ResumeUrls };
type Action = () => void;
...
export function ClientShell({ children, locale, theme, recruiter: initialRecruiter, resumeUrls }: Props) {
  ...
  return <div data-recruiter={recruiter ? "true" : "false"}>
    ...
    {commandOpen && <CommandMenu locale={locale} recruiter={recruiter} close={closeCommand} onLocale={changeLocale} onTheme={changeTheme} onRecruiter={changeRecruiter} resumeUrls={resumeUrls}/>}
  </div>;
}
