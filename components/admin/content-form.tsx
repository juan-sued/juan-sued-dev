...
const skillCategoryOptions = skillCategorySchema.options;
const fields: Record<ContentType, { name: string; label: string; area?: boolean; select?: readonly string[] }[]> = {
  ...
  skills: [{ name: "category_pt", label: "Categoria (PT)" }, { name: "category_en", label: "Categoria (EN)" }, { name: "category", label: "Grupo de competência", select: skillCategoryOptions }, { name: "items", label: "Itens", area: true }],
